...
const dest='/Users/clik/Documents/mrapi2.0/mrapi/node_modules/.mrapi/config.js'
describe('Config', () => {
  beforeEach(() => {
  })
  ...
  test('compileTSFile() dest is not exists', () => {
    ...
    const out1=compileTSFile(filePath,'/Users/clik/Documents/mrapi2.0/mrapi/test-node_modules/not-exsits-dest.js')
    expect(out1).toBe('/Users/clik/Documents/mrapi2.0/mrapi/test-node_modules/not-exsits-dest.js')
    const out2=compileTSFile(filePath,'/Users/clik/Documents/mrapi2.0/mrapi/node_modules/not-exsits-dest.js')
    expect(out2).toBe('/Users/clik/Documents/mrapi2.0/mrapi/node_modules/not-exsits-dest.js')
  });
